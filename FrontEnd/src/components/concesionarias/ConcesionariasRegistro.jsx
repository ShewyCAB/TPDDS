...
export default function ConcesionariasRegistro({
  AccionABMC,
  Item,
  Grabar,
  Volver,
        ...
        <fieldset disabled={AccionABMC === "C"}>
          ...
          <div className="row">
            <div className="col-sm-4 col-md-3 offset-md-1">
              <label className="col-form-label" htmlFor="IdConcesionaria">
                IdConcesionaria<span className="text-danger">*</span>:
              </label>
            </div>
            <div className="col-sm-8 col-md-6">
              <input
                type="integer"
                {...register("IdConcesionaria", {
                  required: { value: true, message: "IdConcesionaria es requerido" },
                  minLength: {
                    value: 1,
                    message: "IdConcesionariadebe tener al menos  caracteres",
                  },
                  maxLength: {
                    value: 4,
                    message: "IdConcesionaria debe tener como máximo 4 caracteres",
                  },
                })}
                ConcesionariaFocus
                className={
                  "form-control " + (errors?.IdConcesionaria ? "is-invalid" : "")
                }
              />
              {errors?.IdConcesionaria && touchedFields.IdConcesionaria && (
                <div className="invalid-feedback">
                  {errors?.IdConcesionaria?.message}
                </div>
              )}
            </div>
          </div>
