        ...
        <fieldset disabled={AccionABMC === "C"}>
          ...
          <div className="row">
            <div className="col-sm-4 col-md-3 offset-md-1">
              <label className="col-form-label" htmlFor="IdAuto">
                IdAuto<span className="text-danger">*</span>:
              </label>
            </div>
            <div className="col-sm-8 col-md-6">
              <input
                type="integer"
                {...register("IdAuto", {
                  required: { value: true, message: "IdAuto es requerido" },
                  minLength: {
                    value: 1,
                    message: "IdAutodebe tener al menos  caracteres",
                  },
                  maxLength: {
                    value: 4,
                    message: "IdAuto debe tener como máximo 4 caracteres",
                  },
                })}
                autoFocus
                className={
                  "form-control " + (errors?.IdAuto ? "is-invalid" : "")
                }
              />
              {errors?.IdAuto && touchedFields.IdAuto && (
                <div className="invalid-feedback">
                  {errors?.IdAuto?.message}
                </div>
              )}
            </div>
          </div>
