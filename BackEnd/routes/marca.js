...
router.get('/api/marca', async (req, res) => {
  try {
    let where = {};
    if (req.query.Idmarca != undefined && req.query.Idmarca !== "") {
      where.Idmarca = {
...
router.get('/api/marca/:Idmarca', async (req, res) => {
  try {
...
router.post('/api/marca', async (req, res) => {
  try {
...
router.put('/api/marca/:Idmarca', async (req, res) => {
  try {
...
router.delete('/api/marca/:Idmarca', async (req, res) => {
  try {
